...
@ray.remote
def multiprocess_func(test_set, train_set, fold, fitness_file, output_file):
    ...
    fitnesses = nn.differential_evolution(population_size, maxIter, batch_size, mutation_rate, cross_over_prob, cost_func[current_data_set])
