#They get a little upset when I store data on gitlab at work, so I feel like it might be good practice to not store it on GitHub either
...
wget https://archive.ics.uci.edu/ml/machine-learning-databases/forest-fires/forestfires.names
...
wget https://archive.ics.uci.edu/ml/machine-learning-databases/cpu-performance/machine.names

#segmentation
wget https://archive.ics.uci.edu/ml/machine-learning-databases/image/segmentation.data
wget https://archive.ics.uci.edu/ml/machine-learning-databases/image/segmentation.names
wget https://archive.ics.uci.edu/ml/machine-learning-databases/image/segmentation.test

#soybean
wget https://archive.ics.uci.edu/ml/machine-learning-databases/soybean/soybean-small.data
wget https://archive.ics.uci.edu/ml/machine-learning-databases/soybean/soybean-small.names
